...
###############For genenrating mcs
write_cfgmem  -format mcs -size 16 -interface SPIx4 -loadbit {up 0x00000000 "thejas_64.bit" } -loaddata {up 0x00400000 "data.bin" } -force -file "data.mcs"
...
set_property PROGRAM.FILES [list "data.mcs" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xc7a100t_0] 0]]
