...
CROSS_COMPILE ?= riscv32-vega-elf
...
RISCV_CFLAGS   += -fno-builtin-printf -fno-builtin-puts -fdata-sections -ffunction-sections -fno-builtin-memcmp -Wno-incompatible-pointer-types #-g -Og -
RISCV_CXXFLAGS += -fno-builtin-printf -fno-builtin-puts -fdata-sections -ffunction-sections -fno-builtin-memcmp  -Wno-incompatible-pointer-types #-g -Og
...
RISCV_LDFLAGS += -nostartfiles  -march=$(RISCV_ARCH) -mabi=$(RISCV_ABI) -mcmodel=$(RISCV_CMODEL)
...
sources_shell_cpp :=  $(shell find . -name "*.cpp")
$(info CPP Files : [${sources_shell_cpp}])
OBJECT_FILES_CPP := $(patsubst %.cpp,$(BIN)/%.o,$(sources_shell_cpp))
...
$(PROGRAM_ELF): $(OBJECT_FILES_C) $(OBJECT_FILES_CPP) $(OBJECT_FILES_S) 
	@echo Linking $^
...
$(OBJECT_FILES_CPP): $(BIN)/%.o: %.cpp
	@echo Compiling $<
	@mkdir -p $(@D)	
	$(CXX) $(RISCV_CXXFLAGS) -c $^ -o $@
...
build_vega_lib: 
	@cd $(SDK_PATH)/bsp/ &&  ./setup.sh "$(TOOLCHAIN_PATH)" "$(RISCV_LIB_FLAGS)" "$(CROSS_COMPILE)"
