...
void main (void)
{
	...
	{		
		for(int i=0;i<400;i++){
			...
			pwmc_continuous_mode(PWM_CH_1,PWM_OPC_LOW,800000,i*2000);
			pwmc_continuous_mode(PWM_CH_2,PWM_OPC_LOW,800000,i*2000);
			pwmc_continuous_mode(PWM_CH_3,PWM_OPC_LOW,800000,i*2000);
			pwmc_continuous_mode(PWM_CH_4,PWM_OPC_LOW,800000,i*2000);
			pwmc_continuous_mode(PWM_CH_5,PWM_OPC_LOW,800000,i*2000);
			pwmc_continuous_mode(PWM_CH_6,PWM_OPC_LOW,800000,i*2000);
			pwmc_continuous_mode(PWM_CH_7,PWM_OPC_LOW,800000,i*2000);
			udelay(800);			
		}
