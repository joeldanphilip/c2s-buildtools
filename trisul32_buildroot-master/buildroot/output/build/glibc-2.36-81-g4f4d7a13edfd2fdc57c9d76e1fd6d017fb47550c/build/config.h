...
#define RISCV_ABI_XLEN 32

/* RISC-V floating-point ABI for ld.so.  */
#define RISCV_ABI_FLEN 0
...
#define __LINUX_KERNEL_VERSION (5 * 65536 + 4 * 256 + 0)

/* Linux specific: __LINUX_KERNEL_VERSION as a string.  */
#define __LINUX_KERNEL_VERSION_STR "5.4.0"

/* Override abi-tags ABI version if necessary.  */
#define __ABI_TAG_VERSION 5,4,0
