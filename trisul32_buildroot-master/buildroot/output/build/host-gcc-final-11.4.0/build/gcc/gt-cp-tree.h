	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (cp_tree_node_structure (&((*x)))))
          ...
          for (i5 = 0; i5 != l5; i5++) {
            {
              ...
              for (i6 = 0; i6 != l6; i6++) {
                switch ((int) (((*x).binding_vec.vec[i5].slots[i6]).is_lazy ()))
                  ...
                  case false:
                    if ((void *)(x) == this_obj)
                      op (&((*x).binding_vec.vec[i5].slots[i6].u.binding), cookie);
                    break;
                  default:
                    break;
                  }
    ...
    case TS_CP_LAMBDA_EXPR:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).lambda_expression.regen_info), cookie);
      if ((void *)(x) == this_obj)
    ...
    case TS_CP_TEMPLATE_INFO:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).template_info.deferred_access_checks), cookie);
      break;
    case TS_CP_CONSTRAINT_INFO:
      if ((void *)(x) == this_obj)
