...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1682,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1683,                       /* -mcmodel= */
  OPT_mcpu_ = 1684,                          /* -mcpu= */
  OPT_mdiv = 1685,                           /* -mdiv */
  OPT_mexplicit_relocs = 1686,               /* -mexplicit-relocs */
  OPT_mfdiv = 1687,                          /* -mfdiv */
  OPT_mglibc = 1688,                         /* -mglibc */
  OPT_misa_spec_ = 1689,                     /* -misa-spec= */
  OPT_mlittle_endian = 1690,                 /* -mlittle-endian */
  OPT_mmusl = 1691,                          /* -mmusl */
  OPT_mplt = 1692,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1693,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1694,                         /* -mrelax */
  OPT_mriscv_attribute = 1695,               /* -mriscv-attribute */
  OPT_msave_restore = 1696,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1697,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1698,             /* -msmall-data-limit= */
